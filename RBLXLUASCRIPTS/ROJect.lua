...
local ROJectx3 = Instance.new("TextButton")
...
execute.MouseButton1Click:Connect(function()
	...
	if injected == false then
		title.Text = "ROJect | Not injected, press attach!"
	end
end)
...
Attach.MouseButton1Click:Connect(function()
	if injected == true then
		title.Text = "ROJect | Already injected!"
		wait(1)
		title.Text = "ROJect"
	end
	if injected == false then
		title.Text = "ROJect | Checking..."
		wait(0.1)
		title.Text = "ROJect | Injecting..."
		wait(1.5)
		title.Text = "ROJect | Checking Whitelist..."
		wait(0.8)
		title.Text = "ROJect | Scanning..."
		wait(0.3)
		title.Text = "ROJect | Ready!"
		wait(0.5)
		title.Text = "ROJect"
		injected = true
		game:GetService("StarterGui"):SetCore("SendNotification",{
			Title = "ROJect", -- Required
			Text = "Successfully injected.", -- Required
			Icon = "rbxassetid://125244948372124" -- Optional
		})
	end
end)
...
title_2.ZIndex = 14
title_2.Image = "http://www.roblox.com/asset/?id=125244948372124"
title_2.ImageRectSize = Vector2.new(138, 167)

scripthub_2.Name = "scripthub"
scripthub_2.Parent = ROJect
...
ROHub.Name = "ROHub"
ROHub.Parent = select
ROHub.BackgroundColor3 = Color3.fromRGB(0, 32, 61)
ROHub.BackgroundTransparency = 1.000
ROHub.BorderColor3 = Color3.fromRGB(0, 0, 49)
ROHub.BorderSizePixel = 0
ROHub.Position = UDim2.new(0.0121960752, 0, 0.136363626, 0)
ROHub.Size = UDim2.new(0, 80, 0, 18)
ROHub.Font = Enum.Font.SourceSans
ROHub.Text = " ROHub"
ROHub.TextColor3 = Color3.fromRGB(255, 255, 255)
ROHub.TextSize = 14.000
ROHub.TextXAlignment = Enum.TextXAlignment.Left
ROHub.ZIndex = 110
ROHub.MouseButton1Click:Connect(function()
	scriptselected = "ROHub"
end)
...
title_3.Text = "ROJect | Script Hub"
...
execute_2.MouseButton1Click:Connect(function()
	if injected == true then
		if scriptselected == "dex" then
			loadstring(game:HttpGet("https://pastebin.com/raw/3zT9Uf9H"))()
		end
		if scriptselected == "ROHub" then
			loadstring(game:HttpGet('https://robloxfan45220.github.io/RBLXLUASCRIPTS/ROHub.lua'))()
		end
		...
		if scriptselected == "backdoor" then
			loadstring(game:HttpGet("https://scriptblox.com/raw/Universal-Script-Backdoor-exe-9413"))()
		end
...
title_4.ZIndex = 110
title_4.Image = "http://www.roblox.com/asset/?id=125244948372124"
...
title_5.Text = "ROJect | Options Menu"
...
title_6.ZIndex = 110
title_6.Image = "http://www.roblox.com/asset/?id=125244948372124"
title_6.ImageRectSize = Vector2.new(138, 167)

ROJectx3.Name = "ROJectx3"
ROJectx3.Parent = optionspage
ROJectx3.BackgroundColor3 = Color3.fromRGB(104, 104, 104)
ROJectx3.BackgroundTransparency = 0.800
ROJectx3.BorderSizePixel = 0
ROJectx3.Position = UDim2.new(0.30757343, 0, 0.391106505, 0)
ROJectx3.Size = UDim2.new(0, 123, 0, 30)
ROJectx3.Font = Enum.Font.Arial
ROJectx3.Text = "ROJect V3"
ROJectx3.TextColor3 = Color3.fromRGB(255, 255, 255)
ROJectx3.TextSize = 14.000
ROJectx3.ZIndex = 110
ROJectx3.MouseButton1Click:Connect(function()
	game.StarterGui:SetCore("SendNotification", {
		Title = "ROJect";
		Text = "ROJect V3 | Coming Soon!";
		Duration = 1;
	})
	ROJectx3.Text = "Coming soon."
	wait(1)
	ROJectx3.Text = "ROJect V3"
end)

UICorner.Parent = ROJect
...
while true do
	...
	if scripthub_2.Visible == true then
		...
		if scriptselected == "dex" then
			descri.Text = "Switch to new, modern ROJect. With integrated console, script hub, options, and much more!"
		end
		if scriptselected == "esp" then
			descri.Text = "Huge command-line script with 300+ commands & 6 years of development."
		end
		if scriptselected == "ROHub" then
			descri.Text = "A powerful script hub that is work in progress."
		end
		if scriptselected == "dumper" then
			descri.Text = "Dumps the place as a '.rbxl' file in your workspace folder."
		end
		if scriptselected == "backdoor" then
			descri.Text = "Scans place for backdoor access and lets you execute server-sided scripts."
		end
	end
end
